// FAQ content shared by the landing FAQ section (client) and the FAQPage
// JSON-LD structured data on the landing page (server). Keep answers plain
// text: they are serialized into schema.org markup verbatim.
