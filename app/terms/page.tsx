      ...
      <main className="flex-1 mx-auto max-w-3xl px-6 py-16">
        ...
        <Section title="5. Refunds">
          <p>
            ...
            <strong>14 days</strong> of purchase, provided you have completed less than 25% of the
            lessons and have not started an exam simulation. Single exam-simulation purchases are
            non-refundable once the simulation has been started. To request a refund, contact us at
            the address below.
          </p>
        </Section>
