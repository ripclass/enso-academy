...
- Still next: more interactive kinds (transaction-network, screening match) + more PBL/interactive seeded scenes; Higgsfield avatars; mock retake-integrity (shuffle options per attempt).
