...
- **Tier 1 — remaining polish:** a thin **scrubber / chapter ticks**; **Higgsfield avatars** (Ripon: DiceBear ones are "bad" → single swap in `components/lesson/classroom/avatar.tsx`).
