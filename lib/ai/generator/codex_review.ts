...
3. **Pedagogical structure.** At least one deep-case scene grounded in a real public enforcement action (named entity + year + substantive analysis). No duplicate concept tags across scenes (each scene teaches distinct concepts). Quizzes are formative and scenario-based, not certification-format mimics ("All of the following EXCEPT" is a red flag).
